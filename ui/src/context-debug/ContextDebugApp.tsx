        ...
        {result && (
          <div className="mt-4 flex flex-col gap-3">
            ...
            <section className="grid grid-cols-2 gap-x-5 gap-y-3 rounded-[var(--radius-lg)] border border-[var(--color-line)] p-4 text-xs">
              ...
              <div><span className="text-[var(--color-fg-faint)]">耗时</span><p className="mt-1 text-[var(--color-fg)]">{result.elapsedMs} ms</p></div>
              <div><span className="text-[var(--color-fg-faint)]">遍历</span><p className="mt-1 text-[var(--color-fg)]">{result.visitedNodes} 个节点{result.truncated ? " · 已裁剪" : ""}</p></div>
            </section>
