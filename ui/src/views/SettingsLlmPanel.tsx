...
const PRESETS = [
  ...
  { adapter: "deepseek", name: "DeepSeek", model: "deepseek-flash", apiKeyUrl: API_KEY_URLS_BY_ADAPTER.deepseek },
  { adapter: "mimo", name: "小米 MiMo", model: "mimo-v2.6-pro", apiKeyUrl: API_KEY_URLS_BY_ADAPTER.mimo },
