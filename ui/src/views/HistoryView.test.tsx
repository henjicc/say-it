...
describe("HistoryView", () => {
  ...
  beforeEach(() => {
    events.clear();
    cmd.mockReset();
    cmd.mockResolvedValue({ items: [{ id: "one", createdAt: 1, taskKind: "dictation", sourceText: "你好", outputText: "你好，世界", instruction: "", appName: "Notepad", processName: "notepad.exe", providerId: "fake", modelId: "fake", status: "succeeded", durationMs: 20 }], total: 1 });
  });
