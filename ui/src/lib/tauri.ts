...
export const CMD = {
  ...
  previewProviderPlugin: "preview_provider_plugin",
  installProviderPlugin: "install_provider_plugin",
  takePendingProviderPluginImports: "take_pending_provider_plugin_imports",
  ...
  getShortcutBindings: "get_shortcut_bindings",
  updateShortcutBinding: "update_shortcut_binding",
  clearShortcutBinding: "clear_shortcut_binding",
  ...
  dictationUseRawText: "dictation_use_raw_text",
  ...
  floatingOrbOpenMainWindow: "floating_orb_open_main_window",
  ...
  floatingOrbDismissError: "floating_orb_dismiss_error",
...
export const EVT = {
  ...
  indicatorError: "dictation-indicator-error",
